...
export const AppGlobalStyle = createGlobalStyle`
  :root {
    ...
    --hero-start: rgba(14, 90, 116, 0.88);
    --hero-end: rgba(20, 32, 42, 0.9);
    --hero-copy: rgba(248, 245, 237, 0.9);
    ...
    --sidebar-panel-border: rgba(248, 245, 237, 0.16);
    --sidebar-panel-bg: linear-gradient(180deg, rgba(20, 32, 42, 0.94), rgba(18, 44, 59, 0.9));
    --sidebar-panel-shadow: 0 16px 34px rgba(12, 24, 34, 0.16);
